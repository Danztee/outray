...
export function Terminal() {
  ...
  return (
    <div className="w-full lg:w-110 bg-black/50 rounded-lg border border-white/10 backdrop-blur-md p-4 md:p-8 font-mono text-sm md:text-base text-gray-300 pointer-events-auto min-h-50 md:min-h-60">
